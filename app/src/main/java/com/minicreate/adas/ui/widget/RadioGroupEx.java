...
public class RadioGroupEx extends RadioGroup {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {  
      ...
      LogUtil.i(TAG, "onMeasure widthMode: " + widthMode + " widthSize: " + widthSize);
      LogUtil.i(TAG, "onMeasure heightMode: " + heightMode + " heightSize: " + heightSize);
      LogUtil.i(TAG, "onMeasure getMeasuredState: " + getMeasuredState());
      LogUtil.i(TAG, "onMeasure getMeasuredWidth: " + getMeasuredWidth()
      ...
      LogUtil.i(TAG, "onMeasure count: " + count);
      ...
      for (int i = 0; i < count; i++) {  
          ...
          LogUtil.i(TAG, "onMeasure deltaX: " + deltaX);
          if (lineWidth + deltaX + getPaddingLeft() + getPaddingRight() > widthSize) {//如果折行,height增加  
              ...
              LogUtil.i(TAG, "maxHeight:" + totalHeight + "---" + "maxWidth:" + maxWidth);
      ...
      LogUtil.w(TAG, "onMeasure maxWidth: " + maxWidth + " totalHeight: " + totalHeight);
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
      LogUtil.d(TAG, "onLayout: " + " changed: " + changed + " left: " + l
